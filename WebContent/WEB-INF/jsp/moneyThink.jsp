...
<body onload="displayLineChart();">
	<div class="top">
		<form action="/B4/MoneyThinkServlet" method="post" class="form">
			<p>
				<input type="text" name="form"> <select name="form"
					class="green">
					<option value="年">年</option>
					<option value="カ月">カ月</option>
				</select> <input type="text" name="form" class="green"> <span
					class="green">円貯める</span>
			</p>
		</form>
		<div class="hero">
		...
		<div class="popup-all">
			...
			<div class="popup-overlay">
				<div class="popup-window">
					...
					<div class="total-cost">固定費合計<!-- ここに固定費の合計を記入 -->円</div>
						<h1>固定費</h1>
						<p>金額</p>
	...
	<div class="bottom">
		...
		<div class="investment">
			...
			<span class="inv-comment"><p class="inv-comment">
				...
				<p class="inv-comment">投資に回す人と比べると</p>
